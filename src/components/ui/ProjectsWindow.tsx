...
const ProjectsWindow = ({ onClose, isActive = true, onClick, onProjectClick }: ProjectsWindowProps) => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      background: 'At Shopee, I focused on seller growth initiatives and marketplace optimization. The goal was to enhance seller experience and drive GMV growth through data-driven product improvements and strategic initiatives.',
      content: 'I conducted in-depth analysis of seller behavior patterns and identified key friction points in the seller journey. Working closely with product and business teams, I developed recommendations to improve seller retention and engagement.\n\nKey achievements:\n• Analyzed seller lifecycle data across 8 Southeast Asian markets\n• Identified growth opportunities worth $2M+ in potential GMV\n• Designed A/B tests for seller onboarding improvements\n• Created comprehensive seller segmentation frameworks\n• Presented insights to C-level executives\n\nThe initiatives I worked on contributed to a 15% improvement in seller retention rates and enhanced the overall marketplace ecosystem.'
    },
    {
      id: '3',
